...
import com.projetopoo.chainofresponsability.desconto.AnoNovoHandler;
import com.projetopoo.chainofresponsability.desconto.Desconto;
import com.projetopoo.chainofresponsability.desconto.DescontoProgressivoHandler;
import com.projetopoo.chainofresponsability.desconto.NatalHandler;
...
public final class ItemController {
    ...
    public void CalcularDesconto(ProdutoModel item){
    
        Desconto anoNovo = new AnoNovoHandler();
        Desconto natal = new NatalHandler();
        Desconto descontoProgressivo = new DescontoProgressivoHandler();
        
        anoNovo.setProximo(natal);
        natal.setProximo(descontoProgressivo);
        
        anoNovo.desconto(item);
